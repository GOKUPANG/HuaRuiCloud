...
@implementation AppDelegateYoosee {
...
+ (AppDelegateYoosee*)sharedDefault
{
    ...
    return ((AppDelegate *)[UIApplication sharedApplication].delegate).yooseeAppDelegate;
}
...
//        [[UIApplication sharedApplication] registerForRemoteNotificationTypes:myTypes];
    ...
    [AppDelegateYoosee getAppVersion];
...
//                [alarmpushcontroller release];
				...
				[rootVC presentViewController:alarmpushcontroller animated:YES completion:nil];
    ...
    switch(alertView.tag){
        case ALERT_TAG_ALARMING:
        {
            ...
            if(buttonIndex==0){
                ...
                if(nil!=contact){
                    ...
                    if (self.isMonitoring) {//监控状态下主动挂断
                        self.isMonitoring = NO;//挂断，不处于监控状态
                        self.isHungUpActively = YES;
                    }
                    
                    self.mainController.contactName = contact.contactName;//昵称显示不对
                    [AppDelegateYoosee sharedDefault].contact = nil;
        ...
        case ALERT_TAG_MONITOR:
        {
            ...
            if(buttonIndex==1){
                ...
                [AppDelegateYoosee sharedDefault].contact = contact;
                [AppDelegateYoosee sharedDefault].mainController.contact = nil;
...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)pToken
{
   ...
   // NSLog(@"我是deviceToken%@",deviceToken);
    
    self.token = [NSString stringWithFormat:@"%@",deviceToken];
    //self.token = @"ce2ed55063e4a1fe4006b443a51440b3954ed6279a0e576fa3ac6d5ecf227ca5";
