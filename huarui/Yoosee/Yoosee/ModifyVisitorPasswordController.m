...
-(void)onClearVisitorPassword{
    NSString *message = [NSString stringWithFormat:@"%@?",NSLocalizedString(@"clear_visitor_pwd", nil)];
    UIAlertView *unBindEmailAlert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"clear_visitor_pwd", nil) message:message delegate:self cancelButtonTitle:NSLocalizedString(@"cancel", nil) otherButtonTitles:NSLocalizedString(@"ok", nil),nil];
