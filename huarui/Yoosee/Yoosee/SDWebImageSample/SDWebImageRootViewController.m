...
- (void)viewDidLoad
{
	...
	[leftButton setBackgroundImage:rightButtonImg forState:UIControlStateNormal];
	[leftButton setBackgroundImage:rightButtonImg_p forState:UIControlStateHighlighted];
	...
	leftButtonIconView.image = [UIImage imageNamed:@"ic_bar_btn_back"];
