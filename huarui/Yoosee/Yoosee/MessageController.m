...
//    footerView.delegate = self;
	footerView = [MJRefreshFooter footerWithRefreshingTarget:self refreshingAction:@selector(refreshViewBeginRefreshing:)];
}

#pragma mark -MJRefreshBaseViewDelegate
- (void)refreshViewBeginRefreshing:(MJRefreshFooter *)refreshView
{
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    if ([AppDelegateYoosee sharedDefault].isNotificationBeClicked) {
        ...
        [AppDelegateYoosee sharedDefault].isNotificationBeClicked = NO;
