...
- (void)viewForCell:(NSUInteger)cell inScroll:(NSUInteger)scroll reusingCell:(UITableViewCell *)tc {
    ...
    switch (scroll) {
        case 0:{
            ...
            tc.textLabel.text=[NSString stringWithFormat:@"%lu",2010+cell];
            break;
        }
        case 1:{
            
            tc.textLabel.text=[NSString stringWithFormat:@"%lu",cell+1];
            break;
        }
        case 2:{
        ...
        case 3:{
            ...
            tc.textLabel.text=[NSString stringWithFormat:@"%lu",(unsigned long)cell];
            break;
        }
        case 4:{
